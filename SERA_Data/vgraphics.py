...
def initCFDGText(theGarden, displayType, percentTimeStamp, maxHeightPlant):
	...
	if sys.platform=="win32":
		...
		CFDGtext=CFDGtext % {"thePathToiPix": "\"../../SERA_Data/i_pix.cfdg\"", "theWorldType": worldTypeCode, "theTimeStamp": timeStampCode, "theWorldTypeRule": worldTypeRule, "theTimeStampRule": CFDGTimeStampRule}
	else:
		CFDGtext=CFDGtext % {"thePathToiPix": "\"../../../SERA_Data/i_pix.cfdg\"", "theWorldType": worldTypeCode, "theTimeStamp": timeStampCode, "theWorldTypeRule": worldTypeRule, "theTimeStampRule": CFDGTimeStampRule}
	return CFDGtext
